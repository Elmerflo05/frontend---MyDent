...
interface CopyFromPresumptiveModalProps {
  isOpen: boolean;
...
export const CopyFromPresumptiveModal = ({
  isOpen,
  presumptiveCount,
  onConfirm,
  onCancel
}: CopyFromPresumptiveModalProps) => {
        ...
        >
          ...
          <div className="bg-blue-50 rounded-lg p-3 mb-6">
            <p className="text-xs text-blue-700">
              Se copiarán <strong>{presumptiveCount} condición(es)</strong> del diagnóstico presuntivo al definitivo.
            </p>
          </div>
