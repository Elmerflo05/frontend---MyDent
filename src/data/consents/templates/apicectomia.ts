...
export const apicectomia: ConsentTemplate = {
  id: 'apicectomia',
  nombre: 'Apicectomía',
  categoria: 'Cirugía',
  contenido: `
        <div style="font-family: Arial, sans-serif; line-height: 1.6; max-width: 800px; margin: 0 auto;">
          <h2 style="text-align: center; font-weight: bold; margin-bottom: 30px; font-size: 14px;">CONSENTIMIENTO INFORMADO PARA LA REALIZACIÓN DE APICECTOMÍA</h2>
          ...
          <p style="text-align: justify; margin-bottom: 15px;">
            ...
            que es conveniente en mi situación proceder a realizar una cirugía periapical a un diente, dándome la siguiente información:
          </p>

          <p style="text-align: justify; margin-bottom: 10px;">
            <strong>1.-</strong> El propósito principal de la intervención es eliminar restos de un proceso infeccioso, (granuloma o quiste periapical).
          </p>
          ...
          <p style="text-align: justify; margin-bottom: 10px;">
            <strong>3.-</strong> La intervención consiste en la incisión a nivel de la mucosa, eliminación de la tabla ósea y por la ventana abierta eliminar
            el ápice de la raíz enferma. Posteriormente se suturará o se cerrará el llegado de la región apical.
          </p>
          ...
          <p style="text-align: justify; margin-bottom: 10px;">
            ...
            edematosos, inflamación, dolor, laceraciones en la mucosa de la mejilla o del labio, o en la lengua, que no tiene la forma o el modo de practicarse
            ...
            correcta realización, puede resultar lesionado el nervio dentario de la mandíbula, lo que implica anestesia o insensibilidad alguna zona de la boca
            o la cara que puede ser transitoria, y menos frecuentemente, permanente. Asimismo, existe también la posibilidad excepcional, e independiente de la
            técnica empleada y su correcta realización, de lesionar el seno y provocar una sinusitis que deba solucionarse por un especialista competente.
          </p>
          ...
          <p style="text-align: justify; margin-bottom: 30px;">
            ...
            y en por ello, <strong>DOY MI CONSENTIMIENTO</strong> para que me practique el tratamiento de apicectomía.
          </p>
