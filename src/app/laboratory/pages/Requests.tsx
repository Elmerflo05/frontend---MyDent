...
const ImagingRequests = () => {
  ...
  // Confirmación de rechazo: solicitudes 'pending' que el técnico descarta
  // cuando el doctor envía una corregida. El motivo es opcional y se le muestra al doctor.
  ...
  /**
   * Confirma y ejecuta el rechazo de una solicitud. El backend sólo permite el
   * rechazo cuando request_status='pending'; si no, responde 409 y se informa en UI.
   * El motivo es opcional y se muestra al doctor en su consulta.
   */
  const confirmDeleteRequest = async () => {
    ...
    try {
      ...
      await radiographyApi.deleteRadiographyRequest(
        requestId,
